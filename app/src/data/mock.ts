...
export const PROJECTS: Project[] = [
  { id: 'pj1', name: 'Campagne Été 2025',     clientId: 'c1', clientName: 'Nova Films',       clientColor: '#3b4f8f', phase: 'production',    phaseLabel: 'Production',    progress: 65, taskCount: 8,  deliverableCount: 3, members: [USERS.sarah, USERS.thomas, USERS.julie], deliveryDate: '15 juin', status: 'info',    statusLabel: 'En cours',         modifiedAt: hoursAgo(1), calendarEnabled: true, filesEnabled: true, financeEnabled: true },
  { id: 'pj2', name: 'Les Bâtisseurs',         clientId: 'c2', clientName: 'Studio Bleu',      clientColor: '#1a6b4a', phase: 'preproduction', phaseLabel: 'Préproduction', progress: 30, taskCount: 14, deliverableCount: 1, members: [USERS.julie, USERS.marc],           deliveryDate: '1 août',  status: 'info',    statusLabel: 'En cours',         modifiedAt: hoursAgo(3), calendarEnabled: true, filesEnabled: true, financeEnabled: true },
  { id: 'pj3', name: 'Film institutionnel 2025',clientId: 'c4', clientName: 'Maison Leroux',    clientColor: '#2d5a7d', phase: 'postproduction',phaseLabel: 'Postproduction',progress: 80, taskCount: 4,  deliverableCount: 2, members: [USERS.sarah, USERS.thomas],         deliveryDate: '20 juin', status: 'ok',      statusLabel: 'En avance',        modifiedAt: daysAgo(1), calendarEnabled: true, filesEnabled: true, financeEnabled: true },
  { id: 'pj4', name: 'Clip Horizon',            clientId: 'c5', clientName: 'Collectif Ondes',  clientColor: '#7d4e57', phase: 'production',    phaseLabel: 'Production',    progress: 45, taskCount: 6,  deliverableCount: 1, members: [USERS.marc, USERS.julie, USERS.sarah],deliveryDate: '28 juin', status: 'danger',  statusLabel: 'En retard',        modifiedAt: hoursAgo(2), calendarEnabled: true, filesEnabled: true, financeEnabled: true },
  { id: 'pj5', name: 'Motion Design Pack',      clientId: 'c6', clientName: 'Agence Vertigo',   clientColor: '#3d3d30', phase: 'livraison',     phaseLabel: 'Livraison',     progress: 92, taskCount: 2,  deliverableCount: 1, members: [USERS.thomas],              deliveryDate: '12 juin', status: 'warn',    statusLabel: 'En attente client',modifiedAt: hoursAgo(4), calendarEnabled: true, filesEnabled: true, financeEnabled: true },
  { id: 'pj6', name: 'Brand Film Q4',           clientId: 'c2', clientName: 'Studio Bleu',      clientColor: '#1a6b4a', phase: 'livraison',     phaseLabel: 'Livraison',     progress: 100,taskCount: 0,  deliverableCount: 5, members: [USERS.sarah, USERS.julie],          deliveryDate: 'Déc 2024',status: 'neutral', statusLabel: 'Complété',         modifiedAt: daysAgo(14), calendarEnabled: true, filesEnabled: true, financeEnabled: true },
];
